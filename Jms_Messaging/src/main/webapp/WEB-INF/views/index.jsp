...
<h3 class="text-muted">Steve's Super Books Order Form</h3>
</div>
...
<div class="col-lg-6">
<h1 class="display-3">Books for everyone!  </h1>
...
<strong>Yes!!, Success!</strong> <span id="message"></span>
</div>
<h4>Customer Id</h4>
...
<footer class="footer">
<p>&copy; Steve's Super Books 2020</p>
</footer>
